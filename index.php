...
?>
  ...
  <section class="hero">
    <div class="img-slider">
      <img src="assets/scas-banner.jpeg" alt="main-logo">
    </div>
  ...
  <section class="featured-products">
    ...
    <div>
      <div class="card">
        <img src="assets/mini-llama-tiny-figurines.jpeg" alt="A miniature llama next to a quarter">
        <h3 class="second-heading">Lucky Little Llamas</h3>
        <h3 class="body-text">Check out these mini llamas! Each mini llama is handcrafted with ethically sourced crystals and wool. Adopt yours today!</h3>
